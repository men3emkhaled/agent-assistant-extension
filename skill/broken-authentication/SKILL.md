...
Authorization: Bearer [HEADER_B64].[PAYLOAD_B64].signature
...
# Remove signature
[MODIFIED_HEADER_B64].[MODIFIED_PAYLOAD_B64].

# Step 4: Submit modified token
Authorization: Bearer [MODIFIED_HEADER_B64].[MODIFIED_PAYLOAD_B64].
```
